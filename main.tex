...
Subtyping relationship of reference capabilities are shown in fig 3. At here, $\kappa$ is reference capability, $\circ$ is temporary type, \extends is showing that left-side type is subtype of right-side type. 
